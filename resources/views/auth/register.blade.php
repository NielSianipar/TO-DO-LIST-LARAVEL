        ...
        <div class="relative z-10">
            <div class="text-center mb-8">
                <a href="{{ route('welcome') }}" class="inline-flex justify-center items-center mb-6 hover:scale-105 transition-transform duration-300">
                    <div class="p-3 bg-gradient-to-br from-brand-500 to-purple-600 rounded-2xl shadow-lg">
                ...
                <p class="text-slate-500 font-medium mt-2">Bergabunglah dan mulai atur tugas Anda.</p>
            </div>
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required autofocus
                            class="w-full pl-11 pr-4 py-3.5 bg-white border-2 border-slate-100 text-slate-800 rounded-2xl focus:outline-none focus:ring-0 focus:border-brand-500 transition-all shadow-sm focus:shadow-md font-semibold placeholder:text-slate-400 placeholder:font-medium" placeholder="Nama Anda">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" required
                            class="w-full pl-11 pr-4 py-3.5 bg-white border-2 border-slate-100 text-slate-800 rounded-2xl focus:outline-none focus:ring-0 focus:border-brand-500 transition-all shadow-sm focus:shadow-md font-semibold placeholder:text-slate-400 placeholder:font-medium" placeholder="Minimal 6 karakter">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password_confirmation" required
                            class="w-full pl-11 pr-4 py-3.5 bg-white border-2 border-slate-100 text-slate-800 rounded-2xl focus:outline-none focus:ring-0 focus:border-brand-500 transition-all shadow-sm focus:shadow-md font-semibold placeholder:text-slate-400 placeholder:font-medium" placeholder="Ulangi kata sandi">
                    </div>
                </div>
                ...
                <div class="pt-3">
                    <button type="submit" class="w-full py-4 bg-slate-900 hover:bg-brand-600 text-white font-bold rounded-2xl transition-all duration-300 shadow-md hover:shadow-glow flex items-center justify-center gap-2">
                        Daftar <i data-lucide="user-plus" class="w-5 h-5"></i>
                    </button>
                </div>
            </form>

            <div class="mt-8 text-center">
                <p class="text-slate-500 font-medium">Sudah punya akun? <a href="{{ route('login') }}" class="text-brand-600 font-bold hover:underline hover:text-brand-700 transition-colors">Masuk di sini</a></p>
            </div>
        </div>
    </div>
